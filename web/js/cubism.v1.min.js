...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>cubism/cubism.v1.min.js at master · square/cubism</title>
...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars0.githubusercontent.com/u/82592?v=3&amp;s=400" property="og:image" /><meta content="square/cubism" property="og:title" /><meta content="https://github.com/square/cubism" property="og:url" /><meta content="cubism - Cubism.js: A JavaScript library for time series visualization." property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="3D941122:0F97:7D27002:547D30C4" name="octolytics-dimension-request_id" /><meta content="4538296" name="octolytics-actor-id" /><meta content="luyucia" name="octolytics-actor-login" /><meta content="27f1a37d436423b0a9a76495cc6228bb914f9be23ba88ee7d275398e77314653" name="octolytics-actor-hash" />
...
<meta content="Uihjea1xYWzZtObiTwPfLRaPAxrsy8PGczxJeToM/4yluq3+qFT77Se3ZpolqdqHLyy4hL57fIbLqL9ngbOxZA==" name="csrf-token" />
...
<ul class="header-nav user-nav right" id="user-links">
  <li class="header-nav-item dropdown js-menu-container">
    <a class="header-nav-link name" href="/luyucia" data-ga-click="Header, go to profile, text:username">
      <img alt="luyucia" class="avatar" data-user="4538296" height="20" src="https://avatars0.githubusercontent.com/u/4538296?v=3&amp;s=40" width="20" />
      <span class="css-truncate">
        <span class="css-truncate-target">luyucia</span>
      </span>
    </a>
  </li>
...
<ul class="dropdown-menu">
  ...
  <li class="header-nav-item">
    <form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="jAHG2O8jepqyN+kcbeW8QHV6+WOveDD8sT509Ph0lFxML6dRyyslh20PFLHRgYnHlhZy8Amgmlv1av6fL/l/eA==" /></div>
...
<ul class="pagehead-actions">
    ...
    <li class="subscription">
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="3aAqumcOJgUedbrZVrhhMlpMsCG2CmWrFQouci8FV9FgYoPG+AEueJMKxQL3xdXtjin+Tj86ZbdfPRlj2lcR0A==" /></div>  <input id="repository_id" name="repository_id" type="hidden" value="3859306" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <form accept-charset="UTF-8" action="/square/cubism/unstar" class="js-toggler-form starred js-unstar-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="/pkEWuu69hHIaZtGgioVMOPb7A43cjm3pd3cpoWgBccOdb1MPw8iGJ5yHhkxFbtzRyKXIDmNTyWA45Be+appDw==" /></div>
      <button
    ...
    <form accept-charset="UTF-8" action="/square/cubism/star" class="js-toggler-form unstarred js-star-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="lJ7ght4VjQJDT7/v+jDAzdhXR9iVUekxhlr5xRxbnbX9vR5K3N0Pc30Xd6/fFKTdK9lT6b1w5ymTK6DkdOgJsw==" /></div>
      <button
        class="minibutton with-count js-toggler-target star-button"
        ...
        <li>
          ...
          <a href="/square/cubism/network" class="social-count">370</a>
        </li>
       ...
       --><strong><a href="/square/cubism" class="js-current-repository" data-pjax="#js-repo-pjax-container">cubism</a></strong>
...
<nav class="sunken-menu repo-nav js-repo-nav js-sidenav-container-pjax js-octicon-loaders"
     ...
     data-issue-count-url="/square/cubism/issues/counts">
  <ul class="sunken-menu-group">
    <li class="tooltipped tooltipped-w" aria-label="Code">
      <a href="/square/cubism" aria-label="Code" class="selected js-selected-navigation-item sunken-menu-item" data-hotkey="g c" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches /square/cubism">
        <span class="octicon octicon-code"></span> <span class="full-word">Code</span>
        <img alt="" class="mini-loader" height="16" src="https://assets-cdn.github.com/images/spinners/octocat-spinner-32.gif" width="16" />
</a>    </li>

      <li class="tooltipped tooltipped-w" aria-label="Issues">
        <a href="/square/cubism/issues" aria-label="Issues" class="js-selected-navigation-item sunken-menu-item" data-hotkey="g i" data-selected-links="repo_issues repo_labels repo_milestones /square/cubism/issues">
    ...
    <li class="tooltipped tooltipped-w" aria-label="Pull Requests">
      <a href="/square/cubism/pulls" aria-label="Pull Requests" class="js-selected-navigation-item sunken-menu-item" data-hotkey="g p" data-selected-links="repo_pulls /square/cubism/pulls">
      ...
      <li class="tooltipped tooltipped-w" aria-label="Wiki">
        <a href="/square/cubism/wiki" aria-label="Wiki" class="js-selected-navigation-item sunken-menu-item" data-hotkey="g w" data-selected-links="repo_wiki /square/cubism/wiki">
  ...
  <ul class="sunken-menu-group">
    ...
    <li class="tooltipped tooltipped-w" aria-label="Pulse">
      <a href="/square/cubism/pulse" aria-label="Pulse" class="js-selected-navigation-item sunken-menu-item" data-selected-links="pulse /square/cubism/pulse">
        <span class="octicon octicon-pulse"></span> <span class="full-word">Pulse</span>
        <img alt="" class="mini-loader" height="16" src="https://assets-cdn.github.com/images/spinners/octocat-spinner-32.gif" width="16" />
</a>    </li>

    <li class="tooltipped tooltipped-w" aria-label="Graphs">
      <a href="/square/cubism/graphs" aria-label="Graphs" class="js-selected-navigation-item sunken-menu-item" data-selected-links="repo_graphs repo_contributors /square/cubism/graphs">
...
<p class="clone-options">You can clone with
  ...
  <a href="http://windows.github.com" class="minibutton sidebar-button" title="Save square/cubism to your computer and use it in GitHub Desktop." aria-label="Save square/cubism to your computer and use it in GitHub Desktop.">
...
<a href="/square/cubism/blob/bda607fcd377d4a849db5c06fb129b26b3430913/cubism.v1.min.js" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:df8ecc6a905f2ad4d0bb1f718e54da8b -->
...
<div class="select-menu js-menu-container js-select-menu left">
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/square/cubism/blob/cyberdelia-librato/cubism.v1.min.js"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/square/cubism/blob/fix-mousemove-half-pixel/cubism.v1.min.js"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/square/cubism/blob/gh-pages/cubism.v1.min.js"
                 data-name="gh-pages"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/square/cubism/blob/master/cubism.v1.min.js"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/square/cubism/blob/options/cubism.v1.min.js"
                 data-name="options"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/square/cubism/tree/v1.6.0/cubism.v1.min.js"
                 data-name="v1.6.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/square/cubism/tree/v1.2.2/cubism.v1.min.js"
                 data-name="v1.2.2"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/square/cubism/tree/v1.2.1/cubism.v1.min.js"
                 data-name="v1.2.1"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/square/cubism/tree/v1.2.0/cubism.v1.min.js"
                 data-name="v1.2.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/square/cubism/tree/v1.1.0/cubism.v1.min.js"
                 data-name="v1.1.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/square/cubism/tree/v1.0.1/cubism.v1.min.js"
                 data-name="v1.0.1"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/square/cubism/tree/v1.0.0/cubism.v1.min.js"
                 data-name="v1.0.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/square/cubism/tree/v0.1.0/cubism.v1.min.js"
                 data-name="v0.1.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/square/cubism/tree/semver/cubism.v1.min.js"
                 data-name="semver"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
  ...
  <div class="commit file-history-tease">
    <div class="file-history-tease-header">
        <img alt="Tom Carden" class="avatar" data-user="39635" height="24" src="https://avatars2.githubusercontent.com/u/39635?v=3&amp;s=48" width="24" />
    ...
    <div class="participation">
      <p class="quickstat">
        <a href="#blob_contributors_box" rel="facebox">
          ...
          <a class="avatar-link tooltipped tooltipped-s" aria-label="mbostock" href="/square/cubism/commits/master/cubism.v1.min.js?author=mbostock"><img alt="Mike Bostock" class="avatar" data-user="230541" height="20" src="https://avatars2.githubusercontent.com/u/230541?v=3&amp;s=40" width="20" /></a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="RandomEtc" href="/square/cubism/commits/master/cubism.v1.min.js?author=RandomEtc"><img alt="Tom Carden" class="avatar" data-user="39635" height="20" src="https://avatars0.githubusercontent.com/u/39635?v=3&amp;s=40" width="20" /></a>
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list">
          ...
          <li class="facebox-user-list-item">
            <img alt="Tom Carden" data-user="39635" height="24" src="https://avatars2.githubusercontent.com/u/39635?v=3&amp;s=48" width="24" />
    ...
    <div class="meta clearfix">
      ...
      <div class="actions">
        <div class="button-group">
          <a href="/square/cubism/raw/master/cubism.v1.min.js" class="minibutton " id="raw-url">Raw</a>
            <a href="/square/cubism/blame/master/cubism.v1.min.js" class="minibutton js-update-url-with-hash">Blame</a>
          <a href="/square/cubism/commits/master/cubism.v1.min.js" class="minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
          ...
          <a class="octicon-button tooltipped tooltipped-nw"
             href="http://windows.github.com" aria-label="Open this file in GitHub for Windows">
              ...
              <a class="octicon-button tooltipped tooltipped-n js-update-url-with-hash"
                 ...
                 href="/square/cubism/edit/master/cubism.v1.min.js"
                 data-method="post" rel="nofollow"><span class="octicon octicon-pencil"></span></a>

            <a class="octicon-button danger tooltipped tooltipped-s"
               href="/square/cubism/delete/master/cubism.v1.min.js"
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.05030s from github-fe129-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
